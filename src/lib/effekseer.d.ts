declare namespace effekseer {
   ...
   */
  export function setProjectionPerspective(
    fov: number,
    aspect: number,
    near: number,
    far: number
   ...
   * @param {number} aspect Distance of far plane
   */
  export function setProjectionOrthographic(
    width: number,
    height: number,
    near: number,
    far: number
   ...
   */
  export function setCameraLookAtFromVector(
    position: object,
    target: object,
    upvec?: object
  ): void;
   ...
   * @returns {EffekseerEffect} The effect data
   */
  export function loadEffectPackage(
